...
| Lot | Status |
|-----|--------|| [BUILD-AUTOVERSION](archive/BUILD-AUTOVERSION.md) — auto-compute the release build number | ✅ || [BUILD-COMMUNITY-SOUNDS](archive/BUILD-COMMUNITY-SOUNDS.md) — Build owns CTLD/CSAR sound preloading | ✅ |
