...
- Docs: documented the static-vs-dynamic VEAF script loading flow and clarified that `VeafDynamicLoader.lua` (framework layer) and `veafDynamicConfig.lua` (mission layer) are complementary, not duplicates — neither is obsolete (new [ADR 0004](docs/adr/0004-dynamic-script-loading.md), DYNLOAD-CLARIFY-001)
