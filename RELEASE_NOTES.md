# VEAF Mission Creation Tools — 6.9.24-rc1 (pré-release de test)
...
> explicitement** — `veaf-tools-updater update --tag published-v6.9.24-rc1`. But :
...
1. `veaf-tools-updater update --tag published-v6.9.24-rc1` dans un dossier de mission (ou
   laissez l'assistant scaffolder avec `tag="published-v6.9.24-rc1"`).
