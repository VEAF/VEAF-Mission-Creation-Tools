...
| **Campaign** | **FOOTHOLD-V6** | Rework the **existing** Foothold process and bring it onto the v6 toolchain. | ➡️ **Now a scoped backlog lot** (FOOTHOLD-V6, pilot: Caucasus) — see ADR 0007/0008. Port of the current setup — distinct from the from-scratch DYNAMIC-CAMPAIGN engine. |
