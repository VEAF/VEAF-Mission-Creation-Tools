...
| CI-NODE24-005 | Follow-up: `docs-chatbot-index.yml` was missed by 001-003 and still ran `actions/setup-node@v4` + `actions/cache@v4` (Node 20). Bumped both to `@v5` (Node 24); repo-wide sweep confirmed no other Node 20 action remains. | `.github/workflows/docs-chatbot-index.yml` | chore | ✅ |
