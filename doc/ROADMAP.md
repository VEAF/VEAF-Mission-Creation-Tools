...
### Release
- ✅ **Releases v6.x** — chaque release part d'une branche `release/x.y.z` mergée dans `master` (la ligne stable v6 depuis la 6.10.0), puis taguée deux fois : `published-vx.y.z` pour les binaires, `vx.y.z` pour la documentation versionnée. Version courante **6.12.0**.
