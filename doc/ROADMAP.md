...
### Release
- ✅ **Releases v6.x** — publication continue depuis `develop-v6` (tags `published-vx.y.z`) ; version courante **6.8.0**. Le merge `develop-v6` → `master` est réservé aux jalons stables.
