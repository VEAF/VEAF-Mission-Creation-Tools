...
Les aliases suivants sont intégrés et disponibles dans toute mission VEAF MCT.
...
- [Guide Pilote — Commandes marqueur](../../pilot/GUIDE.fr.md#commandes-marqueur) — instructions d'utilisation côté joueur
