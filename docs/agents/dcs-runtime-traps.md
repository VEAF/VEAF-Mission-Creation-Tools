...
Above all, **ask for little clearance**. It is a coarse filter and nothing more, so ask where
candidates are still plentiful — 80 m on this mission — and establish the fit yourself, unit by
unit, afterwards. Asking for what you actually need is what makes it go silent.
