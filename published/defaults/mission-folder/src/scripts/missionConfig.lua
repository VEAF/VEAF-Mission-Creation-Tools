...
-------------------------------------------------------------------------------------------------------------------------------------------------------------
veaf.config.MISSION_NAME = "Mission-Name-Not-Set"
...
if veafQraManager then
    ...
    -- VeafQRA.ToggleAllSilence(true) --this will disable all QRA messages if the argument is "true", or enable them (default value) is the argument is "false".
