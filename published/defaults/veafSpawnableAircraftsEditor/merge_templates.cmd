...
echo.
echo Adding or replacing aircraft templates (named "XXX Template YYY") from templates.miz to settings.lua
...
pushd ..\..\\scripts\veaf
"%LUA%" veafSpawnableAircraftsEditor.lua ..\..\defaults\veafSpawnableAircraftsEditor\build ..\..\defaults\veafSpawnableAircraftsEditor\settings.lua %LUA_SCRIPTS_DEBUG_PARAMETER% -import -namefilter ".*[tT]emplate.*"
popd
