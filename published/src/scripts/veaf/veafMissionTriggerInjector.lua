...
--- Version.
veafMissionTriggerInjector.Version = "1.3.0"
...
veafMissionTriggerInjector.trig.actions = {
    ...
    [5] = "a_do_script(\"env.info(\\\"DYNAMIC CONFIG LOADING\\\")\");a_do_script(\"assert(loadfile(VEAF_DYNAMIC_MISSIONPATH .. \\\"/src/scripts/veafDynamicConfig.lua\\\"))()\");",
...
veafMissionTriggerInjector.trigrules = {
    ...
    [3] = {
        ...
        ["actions"] = 
        {
            ...
            [5] = 
            {
                ["text"] = "assert(loadfile(VEAF_DYNAMIC_PATH .. \"/src/scripts/community/CSAR.lua\"))()",
                ["predicate"] = "a_do_script",
            }, -- end of [5]
            [6] = 
            {
            ...
            [10] = 
            {
                ["text"] = "assert(loadfile(VEAF_DYNAMIC_PATH .. \"/src/scripts/community/AIEN.lua\"))()",
                ["predicate"] = "a_do_script",
            }, -- end of [10]
            [11] = 
            {
...
veafMissionTriggerInjector.mapresource = {
    ...
    ["DictKey_ActionText_10205"] = "CSAR.lua",
    ["DictKey_ActionText_10206"] = "WeatherMark.lua",
    ["DictKey_ActionText_10207"] = "skynet-iads-compiled.lua",
    ["DictKey_ActionText_10208"] = "Hercules_Cargo.lua",
    ["DictKey_ActionText_10209"] = "HoundElint.lua",
    ["DictKey_ActionText_10210"] = "AIEN.lua",
