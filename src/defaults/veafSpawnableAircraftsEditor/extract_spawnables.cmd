...
echo.
echo extracting spawnable groups (named "veafSpawn-XXX") from spawnables.miz to settings-spawnables.lua
...
pushd ..\..\\scripts\veaf
"%LUA%" veafSpawnableAircraftsEditor.lua ..\..\defaults\veafSpawnableAircraftsEditor\build ..\..\defaults\veafSpawnableAircraftsEditor\settings-spawnables.lua %LUA_SCRIPTS_DEBUG_PARAMETER% -import -namefilter "veafSpawn-.+"
popd
