...
echo.
echo extracting aircraft templates groups (named "XXX Template YYY") from templates.miz to settings-templates.lua
...
"%SEVENZIP%" x -y templates.miz -o".\build\"

rem -- run the spawnable aircrafts editor
pushd ..\..\\scripts\veaf
"%LUA%" veafSpawnableAircraftsEditor.lua ..\..\defaults\veafSpawnableAircraftsEditor\build ..\..\defaults\veafSpawnableAircraftsEditor\settings-templates.lua  %LUA_SCRIPTS_DEBUG_PARAMETER% -import -namefilter ".*[tT]emplate.*"
popd
