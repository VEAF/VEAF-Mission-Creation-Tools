...
class V5Converter:
    ...
    def _build_mission_yaml(self, report: ConversionReport) -> str:
        ...
        # EN site lives under `/en/`; the anchors below are stable explicit ids declared
        # identically on the FR and EN headings via attr_list (DOC-GUIDE-ANCHORS).
        _lang_seg = "en/" if current_language() == "en" else ""
        _DOC_BASE = f"https://veaf.github.io/documentation/dev/{_lang_seg}mission-maker/GUIDE/"
