...
function veafNamedPoints._addPoint(name, point)
    veaf.loggers.get(veafNamedPoints.Id):trace(string.format("addPoint(name = %s)",name))
    veaf.loggers.get(veafNamedPoints.Id):trace("point=" .. veaf.vecToString(point))
...
function veafNamedPoints.buildAutomaticPointsDatabase()
    ...
    veaf.loggers.get(veafNamedPoints.Id):info(string.format("theatre is %s", theatre))
...
function veafNamedPoints.buildPointsDatabase(customPoints)
...
function veafNamedPoints.initialize(customPoints)
    veafNamedPoints.buildAutomaticPointsDatabase()
    veafNamedPoints.buildPointsDatabase(customPoints)
