...
$WindowTitle = "DCS-SRS Server - 1.9.5.0 - 5002"
$LogfileName = "SRS-public"
$ExePath = "C:\Program Files\DCS-SimpleRadio-Standalone\SR-Server.exe"
$CommandLine = ' -cfg="C:\Users\veaf\Saved Games\public_server_2.5.6\DCS-SimpleRadio-Standalone\server.cfg"'
$WebHookOnFailure = " "
$Priority = "NORMAL"
$InitialDelay = 15
$WatchdogDelay = 30
