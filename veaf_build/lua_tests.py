...
_LUA_INSTALL_HELP = (
    ...
    "\n"
    "Install Lua 5.1:\n"
    "  Windows  no scoop package ships 5.1 (checked 2026-09-21): `lua` is\n"
    "           5.5, and the `lua-for-windows` manifest shims a lua.exe its\n"
    "           own archive does not contain. Use the LuaForWindows\n"
    "           installer, or https://luabinaries.sourceforge.net/,\n"
    "           extracted to\n"
    "           " + str(_WINDOWS_LUA_FALLBACK) + "\n"
    "           which this command finds even when it is not on PATH.\n"
