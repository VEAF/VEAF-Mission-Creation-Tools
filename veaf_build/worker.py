...
class BuildAndReleaseWorker:
    ...
    def build_python_executables(self) -> None:
        ...
        exe_version_file: Path | None = None

        try:
            self._write_version_py(version_py_path)
            exe_version_file = self._write_exe_version_file()
            ...
            with spinner_context("Building veaf-tools executable..."):
                ...
                self._build_pyinstaller_executable(
                    ...
                    extra_data=extra,
                    exe_version_file=exe_version_file,
                )
    ...
    def _write_exe_version_file(self) -> Path | None:
      ...
      [
        StringTable(
          ...
          [StringStruct(u'CompanyName', u'VEAF'),
           ...
           StringStruct(u'InternalName', u'veaf-tools'),
           StringStruct(u'LegalCopyright', u'\\u00a9 VEAF'),
           StringStruct(u'OriginalFilename', u'veaf-tools.exe'),
...
"""
        version_file = Path(tempfile.mktemp(suffix="_veaf_version_file.txt"))
        version_file.write_text(content, encoding="utf-8")
        logger.debug(f"Generated EXE version file: {version_file}")
        return version_file
